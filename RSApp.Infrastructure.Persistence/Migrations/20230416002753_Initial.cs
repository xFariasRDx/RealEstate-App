        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Properties_PropTypes_TypeId",
                        column: x => x.TypeId,
                        principalTable: "PropTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_Sales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyUpgrades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyUpgrades_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyUpgrades_Upgrades_UpgradeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyUpgrades_PropertyId",
                table: "PropertyUpgrades",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyUpgrades_UpgradeId",
                table: "PropertyUpgrades",
                column: "UpgradeId");
        }
